        ...
        <AtomsContainer>
            <div class="grid md:grid-cols-2 gap-10 xl:gap-14 relative">
                <div class="md:py-2 lg:py-4 relative">
                    ...
                    <div class="relative">
                        <AtomsTitle texte="Contacts" />
                        <p class="text-gray-600 dark:text-gray-300 pt-8">
                            Nous sommes à kindonou rue en face de la pharmacie Kindonou
                        </p>
                        <div class="space-y-4 pt-8">
                            <div class="p-4 rounded-xl border border-box-border transition hover:bg-gray-200 dark:hover:bg-box-bg">
                                <h3 class="text-gray-700 dark:text-gray-200 font-semibold text-xl">Tél: +229 66 99 63 23</h3>
                                </div>
                            <div class="p-4 rounded-xl border border-box-border transition hover:bg-gray-200 dark:hover:bg-box-bg">
                                <h3 class="text-gray-700 dark:text-gray-200 font-semibold text-xl">africasoundcity@gmail.com</h3>
                             </div>
                            <div class="p-4 rounded-xl border border-box-border transition hover:bg-gray-200 dark:hover:bg-box-bg">
                                <h3 class="text-gray-700 dark:text-gray-200 font-semibold text-xl">www.africasoundcity.org</h3>
                             </div>
                        </div>
                ...
                <div class="flex md:h-full relative">
                    ...
                    <div
                        ...
                        <img src="/images/a30.jpg" alt="Podcast image" width="300" class="w-2/5 aspect-square absolute bottom-0 right-0 md:left-0 object-cover  rounded-t-[30%] rounded-b-[30%] border-4 border-box-border shadow-md shadow-box-shadow">
                        <img src="/images/a30.jpg" alt="Illustratuin about" width="500"
